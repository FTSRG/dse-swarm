...
/**
 * Pattern-specific match representation of the constraints.PassangerOnVechichleToTarget pattern,
 * to be used in conjunction with {@link PassangerOnVechichleToTargetMatcher}.
 * 
...
public abstract class PassangerOnVechichleToTargetMatch extends BasePatternMatch {
  ...
  private PassangerOnVechichleToTargetMatch(final Passanger pP, final Land pL) {
    this.fP = pP;
    this.fL = pL;
  }
  ...
  public List<String> parameterNames() {
    return PassangerOnVechichleToTargetMatch.parameterNames;
  }
  ...
  @Override
  public PassangerOnVechichleToTargetMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof PassangerOnVechichleToTargetMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    PassangerOnVechichleToTargetMatch other = (PassangerOnVechichleToTargetMatch) obj;
  ...
  @Override
  public PassangerOnVechichleToTargetQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static PassangerOnVechichleToTargetMatch newEmptyMatch() {
   ...
   * 
   */
  public static PassangerOnVechichleToTargetMatch newMutableMatch(final Passanger pP, final Land pL) {
   ...
   * 
   */
  public static PassangerOnVechichleToTargetMatch newMatch(final Passanger pP, final Land pL) {
    return new Immutable(pP, pL);
  }
  
  private static final class Mutable extends PassangerOnVechichleToTargetMatch {
  ...
  private static final class Immutable extends PassangerOnVechichleToTargetMatch {
